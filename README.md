...
- **Windows:** a dedicated category covering Windows 11, 10, 8.1, 8, 7 and XP.
  - Windows 11 and 10 get official, time-limited ISO links from Microsoft through [Fido](https://github.com/pbatard/Fido). Fido is downloaded at runtime and is not bundled with this app.
  - Windows 8.1, 8, 7 and XP use your own licensed ISO (Local tab) or a link from a Visual Studio subscription or Volume Licensing (Custom Source).
...
- Microsoft no longer distributes Windows 8.1, 8, 7 or XP ISOs publicly, so the app does not search for unofficial copies of them.
